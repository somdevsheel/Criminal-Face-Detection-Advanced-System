...
# Real-time face detection from RTSP/HTTP streams
# """
...
#     """
#     Monitor live CCTV streams in real-time
...
#     def start_monitoring(self, stream_url: str, process_fps: int = 1):
#         """
...
#     """WebSocket handler for streaming live detections to web interface"""
...
#     # Example: Monitor RTSP stream
#     # monitor.start_monitoring("rtsp://admin:password@192.168.1.100:554/stream", process_fps=2)
...
#     def _emit_frame(self, frame, face_count):
#         """Emit frame to frontend via WebSocket"""
#         try:
...
#                     # Emit frame with detection count if faces detected
#                     if detections:
#                         self._emit_frame(frame, len(detections))
